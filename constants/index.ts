export const locations = [
  {
    label: 'Văn Phòng Giao Dịch Hà Nội',
    children: [
      {
        prefix: '',
        prefix2: '',
        label: 'SP02.15 Vinhomes Ocean Park - Gia Lâm - HN'
      }
    ]
  },
  {
    ...
    children: [
      {
        prefix: '01',
        prefix2: 'Cơ sở 1:',
        label: 'Số 122, đường 14/10, TT. Tiền Hải'
      },
      { prefix: '02', prefix2: 'Cơ sở 2:', label: 'Khu Hùng Tiến, TT. Vũ Thư' },
      {
        prefix: '03',
        prefix2: 'Cơ sở 3:',
        label: 'Xóm 9, X. Đông Thành, Kiến Xương'
      },
      {
        prefix: '04',
        prefix2: 'Cơ sở 4:',
        label: 'Chợ Tây, Thái Thịnh, Thái Thụy'
      }
    ]
  },
  {
    ...
    children: [
      {
        prefix: '05',
        prefix2: 'Cơ sở 5:',
        label: '1004 tỉnh lộ 15, Tổ 4, Ấp chợ củ 2, X. An Nhơn Tây, H. Củ Chi'
      }
    ]
  }
];
...
export const items = [
  ...
  { href: '/du-hoc-nhat-ban', label: 'Du học Nhật Bản' },
  { href: '/du-hoc-han-quoc', label: 'Du học Hàn Quốc' },
  { href: '/xuat-khau-nhat-ban', label: 'Xuất khẩu Nhật Bản' },
  { href: '/xuat-khau-han-quoc', label: 'Xuất khẩu Hàn Quốc' },
  { href: '/xuat-khau-chau-au', label: 'Xuất khẩu Châu Âu' },
