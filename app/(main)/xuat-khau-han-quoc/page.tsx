        ...
        <div className="relative w-full p-6 bg-white mt-12 z-0">
          ...
          <div className="rounded-xl overflow-hidden border-2 border-primary">
            <table className="table-auto w-full border-collapse leading-8">
              <tbody>
                <tr>
                  <td className="border-r-2 border-b-2 border-dashed border-primary text-center font-semibold min-w-64">
                    Yêu Cầu
                  </td>
                  <td className="border-b-2 border-l-2 border-dashed border-primary p-8">
                    <ul className="list-disc pl-5">
                      <li>
                        Người có độ tuổi từ 18 – 39 tuổi, tùy vào từng loại visa
                        lao động cụ thể sẽ có yêu cầu về độ tuổi khác nhau;
                      </li>
                    </ul>
                  </td>
                </tr>
                <tr>
                  <td className="border-r-2 border-b-2 border-t-2 border-dashed border-primary text-center font-semibold">
                    Bằng Cấp
                  </td>
                  <td className="border-b-2 border-t-2 border-l-2 border-dashed border-primary p-8">
                    <ul className="list-disc pl-5">
                      <li>
                        Có bằng tốt nghiệp THCS/THPT/Trung cấp/Cao đẳng tùy vào
                        tính chất từng công việc và yêu cầu của công ty;
                      </li>
                    </ul>
                  </td>
                </tr>
                <tr>
                  <td className="border-r-2 border-t-2 border-dashed border-primary text-center font-semibold">
                    Yêu Cầu Khác
                  </td>
                  <td className="border-t-2 border-l-2 border-dashed border-primary p-8">
                    <ul className="list-disc pl-5">
                      ...
                      <li>
                        Người không nằm trong danh sách bị cấm nhập cảnh Hàn
                        Quốc;
                      </li>
                      <li>
                        Người không nằm trong danh sách bị cấm xuất cảnh Việt
                        Nam;
                      </li>
                      <li>
                        Tùy vào từng loại visa sẽ có những yêu cầu cụ thể khác
                        nhau;
                      </li>
                    </ul>
                  </td>
        ...
        <div className="relative w-full p-6 bg-white mt-12 z-0">
          ...
          <div className="rounded-xl border-2 border-primary p-8 leading-8">
            <ul className="list-disc pl-64 mt-8">
              <li>
                Chương trình E7: E7-1, E7-2, E7-3 (Đơn hàng: Điện, Sơn, Hàn...)
              </li>
